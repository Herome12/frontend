    ...
    return (
        <div className="container">
            ...
            <div className="button-group">
                <button onClick={() => console.log("Check-In clicked")}>Check-In</button>
                <button onClick={() => console.log("Check-Out clicked")}>Check-Out</button>
                    ...
                    {attendance.length > 0 ? (
                        attendance.map((record) => (
                            <tr key={record._id}>
                                ...
                                <td>{record.checkInTime ? new Date(record.checkInTime).toLocaleString() : "Not Checked-In"}</td>
